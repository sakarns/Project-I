...
-- Generation Time: Jul 1, 2023 at 09:59 PM
...
ALTER TABLE
    `admins` MODIFY `id` int(100) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 2;
...
ALTER TABLE
    `messages` MODIFY `id` int(100) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `products` MODIFY `id` int(100) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `wishlist` MODIFY `id` int(100) NOT NULL AUTO_INCREMENT;
